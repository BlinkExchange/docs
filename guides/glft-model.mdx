...
<Note>
These are the closed-form approximations from Avellaneda & Stoikov (2008). The full GLFT solution (Guéant, Lehalle & Fernandez-Tapia, 2013) uses a finite-horizon ODE with matrix exponential — see the TypeScript market maker implementation for the exact solver.
</Note>
